                    ...
                    <View className="flex space-y-5 p-5">
                        ...
                        <View className="flex">
                            <Text className="text-3xl text-center">
                                <Text className="font-semibold text-blue-500">Welcome</Text>
                                <Text> Back</Text>
                            </Text>
                            <Text className="text-center mt-1">
                                Log in with email to find out the best car for you
                            </Text>
                        </View>
                        ...
                        <TouchableOpacity onPress={signInUser}>
                            <Text className="text-center bg-black text-white text-lg py-2 rounded">Login</Text>
                        </TouchableOpacity>
                        ...
                        <View className="flex flex-row justify-center">
                            ...
                            <Link href={"/(auth)/sign-up"} className="text-blue-500 text-lg font-medium">Register</Link>
                        </View>
